...
final class GtaLikeTeleportConfigScreen extends Screen {
    ...
    public void renderBackground(GuiGraphics context, int mouseX, int mouseY, float tickProgress) {
        ...
        context.renderOutline(outer.x, outer.y, outer.width, outer.height, this.layoutDebugEnabled ? DEBUG_BORDER_COLOR : PANEL_BORDER_COLOR);
    }
    ...
    private static final class DimensionIconButton extends AbstractWidget {
        ...
        private static void drawTextureIcon(GuiGraphics context, int x, int y, double scale, Identifier texture) {
